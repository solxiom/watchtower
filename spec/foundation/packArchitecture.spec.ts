...
const L5_CAPSULE_IMPORT = /from\s+['"]\.\.\/(laneStore|transactionalWriter|managedAssets|runtimeCatalog|packIndex|indexStore|indexQuery|coordinatorBaseline|taskRuntime)\//;
