...
- `coordinator:operator-session:D3`; and
- escalation and operator-session-compaction reserves.
...
- [ ] Operator-session D1–D3 turns have separate pools/reserves and cannot
