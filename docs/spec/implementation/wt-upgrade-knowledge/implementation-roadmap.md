...
| 11 | UK-03 | Atomic upgrade apply, recovery, and downgrade guard | `UK-02`, `RT-04`, `RT-06` | install pointer/store — ✅ Accepted |
| 4 | UK-04 | Codex, Cursor, and Claude knowledge installers | `RT-01`, `RT-02` | host adapters and skill command |
| 12 | UK-05 | Version reporting and upgrade conformance | `UK-03`, `UK-04` | version command/help/integration — ✅ Accepted |
