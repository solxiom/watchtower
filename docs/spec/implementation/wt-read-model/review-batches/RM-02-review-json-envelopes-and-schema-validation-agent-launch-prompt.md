# Agent Launch Prompt — Review Batch RM-02 — Public JSON envelopes and schema validation
...
- [Exact review brief](RM-02-review-json-envelopes-and-schema-validation.md) — read in full.
- Accepted implementation map, normative specifications, pack quality rules, current source, accepted predecessor evidence, tracker, and exact checkout.

## Complete batch-specific scope

- **Title:** Public JSON envelopes and schema validation
...
- **Mandatory proof:** Success/error envelopes; additive compatibility; no decorative JSON output; staged-schema and isolated-install proof
- **Review report:** `.local/agent-reports/wt-read-model/reviews/RM-02-json-envelopes-and-schema-validation-review.md`
- **Correction report pattern:** `.local/agent-reports/wt-read-model/reviews/corrections/RM-02-json-envelopes-and-schema-validation-correction-<NN>.md`
