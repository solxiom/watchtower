...
| RM-02 | Public JSON envelopes and schema validation | 🚫 Preserved; prerequisites/pack activation | Success/error envelopes; additive compatibility; no decorative JSON output; staged-schema and isolated-install proof |
