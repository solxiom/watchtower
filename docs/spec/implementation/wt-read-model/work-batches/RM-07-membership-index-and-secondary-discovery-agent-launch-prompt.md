# Agent Launch Prompt — Work Batch RM-07 — Membership index and secondary-repository discovery
...
- [Exact work brief](RM-07-membership-index-and-secondary-discovery.md) — read in full.
