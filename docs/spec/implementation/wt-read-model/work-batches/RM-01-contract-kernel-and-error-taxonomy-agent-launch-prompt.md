# Agent Launch Prompt — Work Batch RM-01 — Contract kernel, error taxonomy, and source architecture gates
...
- [Exact work brief](RM-01-contract-kernel-and-error-taxonomy.md) — read in full.
