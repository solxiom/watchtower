# Agent Launch Prompt — Work Batch RM-11 — Repository NVB parent-chain composition
...
- [Exact work brief](RM-11-repository-nvb-parent-chain-composition.md) — read in full.
- Accepted implementation map, normative specifications, pack quality rules, current source, accepted predecessor evidence, tracker, and exact checkout.

## Complete batch-specific scope

- **Title:** Repository NVB parent-chain composition
- **Dependencies:** `RM-01`
- **Exclusive ownership/interface:** development NVB parent chain and architecture gates
- **Implementer/reviewer floors:** R4 / R4
- **Mandatory proof:** Effective-task equivalence; duplicate/circular parent rejection; every hand-maintained registry within limit
- **Implementation report:** `.local/agent-reports/wt-read-model/RM-11-repository-nvb-parent-chain-composition.md`
- **Correction report pattern:** `.local/agent-reports/wt-read-model/reviews/corrections/RM-11-repository-nvb-parent-chain-composition-correction-<NN>.md`
