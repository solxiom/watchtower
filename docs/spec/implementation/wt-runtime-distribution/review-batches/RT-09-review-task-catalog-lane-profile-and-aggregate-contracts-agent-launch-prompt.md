# Agent Launch Prompt — Review Batch RT-09 — Task catalog, lane profile, and aggregate contracts
...
- [Exact review brief](RT-09-review-task-catalog-lane-profile-and-aggregate-contracts.md) — read in full.
