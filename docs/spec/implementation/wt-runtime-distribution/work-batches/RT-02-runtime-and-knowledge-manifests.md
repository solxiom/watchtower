...
Exclusive map ownership: runtime/knowledge manifest contracts and validators.
...
5. Independently reproducible acceptance claim: Every asset/checksum/mode/action represented; missing/extra/checksum/mode rejection.
...
- Exact implementation report: `.local/agent-reports/wt-runtime-distribution/RT-02-runtime-and-knowledge-manifests.md`
...
The exclusive owned interface set is **runtime/knowledge manifest contracts and validators**. Before editing, resolve those named owners to exact existing or proposed modules, public symbols, schema/help/task identifiers, and focused specs in the assigned checkout. Record that source-backed mapping in `.local/agent-reports/wt-runtime-distribution/RT-02-runtime-and-knowledge-manifests.md`. Do not move behavior into a generic helper, a command, a TaskHandler, a mutable registry, workflow shell, or an adjacent batch owner.
...
Do not commit or issue a verdict. Only after every gate passes, write `.local/agent-reports/wt-runtime-distribution/RT-02-runtime-and-knowledge-manifests.md`, truthfully record this batch's handoff readiness without changing unrelated tracker rows, and emit exactly one replay-safe handoff. A correction retains lineage and reruns both impacted and original acceptance proof.
