# Agent Launch Prompt — Review Batch LC-04 — Bindings, Git-ignore, and membership registration
...
- [Exact review brief](LC-04-review-bindings-gitignore-and-membership-registration.md) — read in full.
