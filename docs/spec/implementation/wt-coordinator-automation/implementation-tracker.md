...
| CA-16 | Session SQLite index, references, pins, and compaction | ✅ Accepted | Bounded metadata/excerpts; exact text remains journal-owned; same-lane capsules; no full-history fallback |
