...
|---|---|---|---|
| CA-01 | Deterministic sealed-pack SQLite compiler | ❌ Pending | Identical logical rows/semantic root; path/digest/FK checks; staged immutable publication; linear build |
