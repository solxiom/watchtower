...
> **Accepted repack (2026-07-31).** CA-18 through CA-24 replace the historical
> monolithic attachment batch. Their exact bootstrap pack bytes are accepted
> and sealed by `../pack-acceptance-review.md`.
