# Agent Launch Prompt — Work Batch CA-28 — OpenCode decision-endpoint adapter
...
- [Exact work brief](CA-28-opencode-decision-endpoint-adapter.md) — read in full.
- Accepted implementation map, normative specifications, pack quality rules, current source, accepted predecessor evidence, tracker, and exact checkout.

## Complete batch-specific scope

- **Title:** OpenCode decision-endpoint adapter
- **Dependencies:** `CA-06`, `RT-05`
- **Exclusive ownership/interface:** focused OpenCode CLI adapter
- **Implementer/reviewer floors:** R4 / R4
- **Mandatory proof:** Required unattended conformance; bounded argv/env/cwd/result; fresh catalog/model fingerprint
- **Implementation report:** `.local/agent-reports/wt-coordinator-automation/CA-28-opencode-decision-endpoint-adapter.md`
- **Correction report pattern:** `.local/agent-reports/wt-coordinator-automation/reviews/corrections/CA-28-opencode-decision-endpoint-adapter-correction-<NN>.md`
