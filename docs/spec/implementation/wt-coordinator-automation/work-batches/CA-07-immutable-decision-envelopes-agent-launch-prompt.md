...
14. the canonical source owners you will actually change:
    ...
    - `src/foundation/DecisionEnvelope.ts` (create)
    - `spec/basic/decisionEnvelope.spec.ts` (create)
...
2. Create `src/foundation/DecisionEnvelope.ts` with `DecisionEnvelopeBuilder`:
