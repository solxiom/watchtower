...
15. the canonical source owners you will actually change:
    - `src/foundation/CapabilityFloors.ts` (create)
    - `src/foundation/RoutingPolicy.ts` (create)
    - `spec/basic/routingPolicy.spec.ts` (create)
...
1. Create `src/foundation/CapabilityFloors.ts` with `CapabilityFloor` enum
