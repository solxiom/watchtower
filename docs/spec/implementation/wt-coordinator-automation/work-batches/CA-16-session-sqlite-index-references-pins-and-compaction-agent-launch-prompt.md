...
13. the canonical source owners you will actually work with:
    - `src/foundation/SessionIndexes.ts` (create)
    - `src/foundation/SessionCompaction.ts` (create)
...
1. Create `src/foundation/SessionIndexes.ts` with: the complete SQLite schema
...
2. Create `src/foundation/SessionCompaction.ts` with: index-only compaction
