# Agent Launch Prompt — Work Batch CA-17 — Session routing and budgets
...
- [Exact work brief](CA-17-session-routing-budgets-proposals-holds-and-amendments.md) — read in full.
