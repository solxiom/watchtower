# Agent Launch Prompt — Work Batch CA-04 — Ready set and resource-claim projection
...
- [Exact work brief](CA-04-ready-set-and-resource-claim-projection.md) — read in full.
- Accepted implementation map, normative specifications, pack quality rules, current source, accepted predecessor evidence, tracker, and exact checkout.

## Complete batch-specific scope

- **Title:** Ready set and resource-claim projection
- **Dependencies:** `RM-08`, `CA-01`, `CA-03`
- **Exclusive ownership/interface:** scheduling projection
- **Implementer/reviewer floors:** R5 / R5
- **Mandatory proof:** DAG/dependency/claim/capacity blockers; no arbitrary winner
- **Implementation report:** `.local/agent-reports/wt-coordinator-automation/CA-04-ready-set-and-resource-claim-projection.md`
- **Correction report pattern:** `.local/agent-reports/wt-coordinator-automation/reviews/corrections/CA-04-ready-set-and-resource-claim-projection-correction-<NN>.md`
