# Agent Launch Prompt — Work Batch CA-15 — Operator-session persistence and lifecycle
...
- [Exact work brief](CA-15-operator-session-persistence-and-lifecycle.md) — read in full.
