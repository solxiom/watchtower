# Agent Launch Prompt — Work Batch CA-02 — SQLite index stores and bounded typed queries
...
- [Exact work brief](CA-02-sqlite-index-stores-and-bounded-typed-queries.md) — read in full.
