# Agent Launch Prompt — Work Batch CA-13 — Coordinator queue, cursor, replay, and watcher task integration
...
- [Exact work brief](CA-13-coordinator-queue-cursor-replay-and-watcher-integration.md) — read in full.
