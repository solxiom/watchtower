...
| CA-09 | Typed proposals and current-state validator | [work](work-batches/CA-09-typed-proposals-and-current-state-validator.md) | [review](review-batches/CA-09-review-typed-proposals-and-current-state-validator.md) | ✅ Accepted |
...
| CA-16R | Session SQLite index, references, pins, and compaction — successor publication | [published successor evidence](../../schemas/session-index-v2/) | [accepted successor review](../../schemas/session-index-v2/) | ✅ Accepted |
