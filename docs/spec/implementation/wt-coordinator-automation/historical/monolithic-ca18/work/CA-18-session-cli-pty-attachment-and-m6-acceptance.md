# Historical Batch CA-18 — Session CLI/PTY Attachment and M6 Acceptance

> **Archived outside active batch directories. Do not implement.** The full-screen TUI amendment
> decomposes this scope into `CA-18` through `CA-24` in
> `docs/spec/v1-implementation-map.md §8`. This historical brief is not
