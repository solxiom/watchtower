# Correction Briefs — Watchtower v1 Coordinator Automation
...
```
<batch-number>-correction-<sequence>.md
```

Example: `CA-03-correction-01.md` is the first correction for batch CA-03.
