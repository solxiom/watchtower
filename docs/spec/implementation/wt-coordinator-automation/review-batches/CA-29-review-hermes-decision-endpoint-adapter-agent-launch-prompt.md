# Agent Launch Prompt — Review Batch CA-29 — Hermes decision-endpoint adapter
...
- [Exact review brief](CA-29-review-hermes-decision-endpoint-adapter.md) — read in full.
- Accepted implementation map, normative specifications, pack quality rules, current source, accepted predecessor evidence, tracker, and exact checkout.

## Complete batch-specific scope

- **Title:** Hermes decision-endpoint adapter
- **Dependencies:** `CA-06`, `RT-05`
- **Exclusive ownership/interface:** focused Hermes CLI adapter
- **Implementer/reviewer floors:** R4 / R4
- **Mandatory proof:** Same conformance when installed; explicit healthy `not-installed` outcome
- **Review report:** `.local/agent-reports/wt-coordinator-automation/reviews/CA-29-hermes-decision-endpoint-adapter-review.md`
- **Correction report pattern:** `.local/agent-reports/wt-coordinator-automation/reviews/corrections/CA-29-hermes-decision-endpoint-adapter-correction-<NN>.md`
