# Agent Launch Prompt — Review Batch CA-01 — Deterministic sealed-pack SQLite compiler
...
- [Exact review brief](CA-01-review-deterministic-sealed-pack-sqlite-compiler.md) — read in full.
- Accepted implementation map, normative specifications, pack quality rules, current source, accepted predecessor evidence, tracker, and exact checkout.

## Complete batch-specific scope

- **Title:** Deterministic sealed-pack SQLite compiler
- **Dependencies:** `DB-01`, `LC-02`, `LC-03`
- **Exclusive ownership/interface:** pack index foundation
- **Implementer/reviewer floors:** R5 / R5
- **Mandatory proof:** Identical logical rows/semantic root; path/digest/FK checks; staged immutable publication; linear build
