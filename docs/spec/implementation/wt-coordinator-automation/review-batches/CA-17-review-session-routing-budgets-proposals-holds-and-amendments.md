...
1. **File ownership:** Verify `src/foundation/session-routing.ts`,
   `src/foundation/session-budgets.ts`, `src/foundation/session-holds.ts`,
   and `src/foundation/session-proposals.ts` are the only new files (or a
...
- `src/foundation/session-routing.ts` ≤250 lines. Verify physical line count.
  At 201+, require responsibility inventory.
- `src/foundation/session-budgets.ts` ≤250 lines. Verify physical line count.
  At 201+, require responsibility inventory.
- `src/foundation/session-holds.ts` ≤200 lines. Verify physical line count.
- `src/foundation/session-proposals.ts` ≤250 lines. Verify physical line count.
