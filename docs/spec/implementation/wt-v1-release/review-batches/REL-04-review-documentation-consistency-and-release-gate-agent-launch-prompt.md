...
- No new source files are expected in the diff beyond tracker updates.
- The audit report is a `.local/` artifact; verify it is organized in clearly labeled sections.
