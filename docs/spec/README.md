...
| [operator-session-draft.md](operator-session-draft.md) | Draft | Normative v1 bounded multi-turn operator session and confirmed-effect boundary |
| [cli-session-draft.md](cli-session-draft.md) | Draft | Normative v1 foreground attachment, terminal UX, slash commands, streaming, and accessibility |
