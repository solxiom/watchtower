...
*(LC-07, delivered)* below. Batch LC-10 delivers five additional injected diagnostic providers, composed
through the unmodified LC-07 kernel: a required-external-tools check and an installed-runtime check (the two
bullets marked *(LC-10, delivered)* below), an effective-account-access check covering exactly §7.1's control-home/runtime-root
...
- runtime manifest, links, executability, and checksums; *(LC-10, delivered)*
