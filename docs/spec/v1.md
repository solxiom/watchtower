...
| `wt coordinator session` | ❌ | Create a new session and open its full-screen TUI attachment |
| `wt coordinator session attach <id> [--observe]` | ❌ | Open a full-screen TUI attachment to an existing session |
