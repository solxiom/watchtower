...
- Building or querying repository source-intelligence indexes. The separate
  capability is drafted in
  [source-intelligence-draft.md](source-intelligence-draft.md); it cannot merge
  with or weaken the required seal-bound coordinator pack index.
