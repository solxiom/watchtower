...
| `wt coordinator index|status|context|explain|cycle|escalate` | ⏳ | Read-only index/status/context/explain projections are implemented; mutation and cycle operations remain pending |
